(function () {
    ...
    var Y = "",
        ...
        M = [{
            ...
            name: "大油漆桶",
            descr: "它使您的油漆桶容量在上一级的基础上 x2，例如1级是x2、2级是x4、3级是x8、4级是x16...以此类推。 继续使用油漆以获得更高级的成就。",
            reqValue: [],
            reqValueFnc: function (a) {
            ...
            name: "快速油漆桶补货",
            descr: "它使您的油漆桶补货速度在上一级的基础上 x2，例如1级是x2、2级是x4、3级是x8、4级是x16...以此类推。 为了达到这个成就，将油漆桶清空至小于5％，然后等待它完全补充。",
            reqValue: [],
            reqValueFnc: function (a) {
